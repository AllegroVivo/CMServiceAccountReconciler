...
from ..Classes import AnnualCSRData
################################################################################

__all__ = ("AnnualWorksheet", )

################################################################################
class AnnualWorksheet(_WorksheetBase):
    ...
    def _parse_record(self, row: List[Dict[str, Any]], row_index: int) -> Optional[SheetRecord]:
        ...
        csr_highlight = row[5]["effectiveFormat"]["backgroundColorStyle"].get("rgbColor")
